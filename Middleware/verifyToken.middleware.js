...
module.exports = (req,res,next)=>{
  ...
  if(req.originalUrl!=="/api/register" && req.originalUrl!=="/api/verify" && req.originalUrl!=="/api/login" && req.originalUrl!=="/api/webhooks" && req.originalUrl!=="/api/image-upload" && req.originalUrl.includes('/api')){
